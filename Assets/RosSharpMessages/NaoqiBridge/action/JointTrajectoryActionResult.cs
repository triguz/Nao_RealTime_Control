...
namespace RosSharp.RosBridgeClient.MessageTypes.NaoqiBridge
{
    ...
    {
        [JsonIgnore]
        public const string RosMessageName = "naoqi_bridge_msgs/JointTrajectoryActionResult";
        ...
        public JointTrajectoryActionResult(Header header, GoalStatus status, JointTrajectoryResult result) : base(header, status)
        {
            this.result = result;
        }
    }
