...
namespace RosSharp.RosBridgeClient.MessageTypes.NaoqiBridge
{
    ...
    {
        [JsonIgnore]
        public const string RosMessageName = "naoqi_bridge_msgs/FollowPathActionGoal";
        ...
        public FollowPathActionGoal(Header header, GoalID goal_id, FollowPathGoal goal) : base(header, goal_id)
        {
            this.goal = goal;
        }
    }
