...
namespace RosSharp.RosBridgeClient.MessageTypes.NaoqiBridge
{
    ...
    {
        [JsonIgnore]
        public const string RosMessageName = "naoqi_bridge_msgs/FollowPathActionResult";
        ...
        public FollowPathActionResult(Header header, GoalStatus status, FollowPathResult result) : base(header, status)
        {
            this.result = result;
        }
    }
